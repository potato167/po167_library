...
data:
  ...
  code: "#pragma once\n#include <vector>\n#include <utility>\n#include <cassert>\n\
    ...
    \u5728\u3059\u308B\u306A\u3089\u3001\n * \u9802\u70B9\u756A\u53F7\u306E\u5217\u3068\
    \u8FBA\u756A\u53F7\u306E\u5217\u3092\u3069\u3061\u3089\u3082\u8FD4\u3059\n * \u5165\
    \u529B : vector<vector<pair<int, int>>> \u30B0\u30E9\u30D5, \u8FBA\u306E\u6570\
    , start\n * \u51FA\u529B : \u9802\u70B9\u306E\u5217\u3068\u8FBA\u306E\u756A\u53F7\
    \u306E\u5217\u306E pair\n *\n * start \u5730\u70B9\u306B\u3064\u3044\u3066\n *\
    \ -1 \u306B\u3057\u3066\u304A\u304F\u3068\u3001\u305D\u306E\u5F8C\u306E dir \u3092\
    \u307F\u3066\u81EA\u52D5\u7684\u306B\u6C42\u3081\u308B\n * dir : true  -> \u51FA\
    ...
    \ Eulerian_trail(\n    std::vector<std::vector<std::pair<int, int>>> g, int n_edge,\
    \ int start = -1, bool dir = false\n){\n    int N = (int)g.size();\n    // \u30B9\
    \u30BF\u30FC\u30C8\u5730\u70B9\u4E0D\u5B9A\n    if (start == -1){\n        //\
    \ \u6709\u5411\u30B0\u30E9\u30D5\u306E\u3068\u304D\n        if (dir){\n      \
    \      std::vector<int> sc(N);\n            for (int i = 0; i < N; i++){\n   \
    \             for (auto [to, ind] : g[i]){\n                    sc[i]++;\n   \
  ...
  requiredBy: []
  timestamp: '2026-03-25 04:36:12+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/graph/eulerian_trail_undir.test.cpp
  - test/graph/eulerian_trail_dir.test.cpp
