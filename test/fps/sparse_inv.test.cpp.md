...
data:
  ...
  bundledCode: "#line 1 \"test/fps/sparse_inv.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/inv_of_formal_power_series_sparse\"\
    ...
    \ (T)(n);\n            }\n            if (a < i){\n                res[i] -= b\
    \ * res[i - a] * (T)(i - a);\n            }\n        }\n        res[i] *= inv;\n\
    \        res[i] *= invs[i];\n    }\n    return res;\n}\n}\n#line 4 \"test/fps/sparse_inv.test.cpp\"\
    \n\n#include <iostream>\n#include <atcoder/modint>\nusing mint = atcoder::modint998244353;\n\
    int main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    int N, K;\n    std::cin >> N >> K;\n    std::vector<mint> f(N);\n    for\
    \ (int i = 0; i < K; i++){\n        int a, b;\n        std::cin >> a >> b;\n \
    \       f[a] = b;\n    }\n    auto ans = po167::FPS_sparse_inv(f);\n    for (int\
  ...
  verifiedWith: []
documentation_of: test/fps/sparse_inv.test.cpp
layout: document
redirect_from:
- /verify/test/fps/sparse_inv.test.cpp
- /verify/test/fps/sparse_inv.test.cpp.html
