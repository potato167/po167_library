...
data:
  ...
  bundledCode: "#line 1 \"test/graph/eulerian_trail_dir.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/eulerian_trail_directed\"\n\n#line 2 \"graph/Eulerian_trail.hpp\"\
    \n#include <vector>\n#include <utility>\n#include <cassert>\n#include <algorithm>\n\
    \nnamespace po167{\n/*\n * \u30B0\u30E9\u30D5\u3092\u4E0E\u3048\u308B\u3002\n\
    \ * \u8FBA\u306F pair<int, int> \u3067\u3001{\u884C\u304D\u5148\u3001\u8FBA\u306E\
    \ index}\n * \u30AA\u30A4\u30E9\u30FC\u30A6\u30A9\u30FC\u30AF\u304C\u5B58\u5728\
    \u3059\u308B\u306A\u3089\u3001\n * \u9802\u70B9\u756A\u53F7\u306E\u5217\u3068\u8FBA\
    \u756A\u53F7\u306E\u5217\u3092\u3069\u3061\u3089\u3082\u8FD4\u3059\n * \u5165\u529B\
    \ : vector<vector<pair<int, int>>> \u30B0\u30E9\u30D5, \u8FBA\u306E\u6570, start\n\
    \ * \u51FA\u529B : \u9802\u70B9\u306E\u5217\u3068\u8FBA\u306E\u756A\u53F7\u306E\
    \u5217\u306E pair\n *\n * start \u5730\u70B9\u306B\u3064\u3044\u3066\n * -1 \u306B\
    \u3057\u3066\u304A\u304F\u3068\u3001\u305D\u306E\u5F8C\u306E dir \u3092\u307F\u3066\
    \u81EA\u52D5\u7684\u306B\u6C42\u3081\u308B\n * dir : true  -> \u51FA\u6B21 - \u5165\
    ...
    \ res_edge.end());\n    return {res_var, res_edge};\n}\n}\n#line 4 \"test/graph/eulerian_trail_dir.test.cpp\"\
